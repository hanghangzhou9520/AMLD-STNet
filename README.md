# [Adaptive Multi-scale Lagrange Dynamics Spatial-Temporal Network for 3D Skeleton-based Human Motion Prediction](https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=11363270)
